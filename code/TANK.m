...
QO = textread('vaz_ijui.txt','%f');                % vazão observado em m3/s
P = textread('prec_ijui.txt','%f');          % Precitacão em mm/dia
ETR  = textread('evap_ijui.txt','%f');  % Evapotranspiração mm/dia
NT=length(QO);
