...
QO = textread('vaz_canoas.txt','%f');                % vazão observado em m3/s
P = textread('prec_canoas.txt','%f');          % Precitacão em mm/dia
ETR  = textread('evap_canoas.txt','%f');  % Evapotranspiração mm/dia
NT=length(QO);
